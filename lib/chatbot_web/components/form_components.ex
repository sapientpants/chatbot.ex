defmodule ChatbotWeb.FormComponents do
  @moduledoc """
  Form-related UI components including inputs, selects, and form wrappers.
  """
  use Phoenix.Component
  use Gettext, backend: ChatbotWeb.Gettext

  import ChatbotWeb.CoreComponents, only: [icon: 1, translate_error: 1]
