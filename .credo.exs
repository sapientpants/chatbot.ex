# Credo configuration for static code analysis
...
%{
  configs: [
    %{
      ...
      requires: [],
      #
      # Strict mode is enabled by using --strict flag on the command line
      #
      strict: true,
      #
      # Use ANSI color codes for better output visualization
      #
      color: true,
      #
